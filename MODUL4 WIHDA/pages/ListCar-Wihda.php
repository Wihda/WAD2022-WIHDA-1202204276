...
<html lang="en">
  ...
  <body>
    ...
    <?php
			...
			$query = mysqli_query($conn, "SELECT * FROM showroom_wihda_table") or die("database error:". mysqli_error($conn));
      ...
      while( $record = mysqli_fetch_assoc($query) ) {
        ...
        ?>
          ...
          <div class="col-sm">
            ...
            <img class="card-img-top p-3" src="../asset/images/<?php echo $record["foto_mobil"];?>" alt=""> 
            <div class="card-body">
            ...
            <div class="card-footer">
              <div class="row justify-content-start">
                <div class="col-4">
              <form action="Detail-Wihda.php" method="post" >
