  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark p-3">
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active" href="HomeBefore-Wihda.php" style="margin-left:50px">Home</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item"><a class="nav-link active" href="Login-Wihda.php" style="margin-right:50px">Login</a></li>
            </ul>
        </div>
    </nav>
    <div class="container">
    <div class="row align-items-center" style="padding-top: 100px">
        ...
        <div class="col"> 
            <img src="..\asset\images\dodge-viper-car-road-1.jpg" class="rounded" alt="car" style="width: 100%">
        </div>
    </div>
    </div>
