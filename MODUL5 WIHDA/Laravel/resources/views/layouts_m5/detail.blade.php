...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark p-3">
        <div class="container-fluid">
            <ul class="navbar-nav pl-3">
                <li class="nav-item"><a class="nav-link active" href="/layouts_m5/{{$mobil->id}}/add" style="margin-left:50px">Home</a></li>
                <li class="nav-item"><a class="nav-link active" href="/layouts_m5/{{$mobil->id}}/list-car" style="margin-left:50px">MyCar</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
            <li><a href="/layouts_m5/{{$mobil->id}}/add" class="btn btn-light btn-outline-primary" style="margin-right:50px">Add Car</a></li>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="/layouts_m5/{{$mobil->id}}/profil">Profil</a></li>
    ...
    <?php
        ...
        $query = mysqli_query($conn, "SELECT * FROM showrooms WHERE id_mobil='$id'") or die("database error:". mysqli_error($conn));
    ...
    <div class="col">
        <form action="{{route('layouts_m5.edit')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="name" class="form-label"><strong>Nama Mobil</strong></label>
                    ...
                    <form action="{{route('layouts_m5.edit')}}" method="POST" >
                        <input type="hidden" name="id_mobil" value="<?php echo $id; ?>" />
