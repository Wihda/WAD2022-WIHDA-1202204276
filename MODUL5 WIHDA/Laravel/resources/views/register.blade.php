...
<html lang="en">
  ...
  <body>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
        <div class="row">
            <div class="col-6">
                <img src="..\MODUL4 WIHDA\images\lambor.jpg" style="width:100%">
            </div>
            <div class="col-6" style="padding-top:30px; padding-left:100px">
                <h3>Register</h3><br>
                <form action="{{url('/layouts_m5/profil')}}" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="Email" class="form-label">Email</label>
                        <input type="text" class="form-control" name="email_pengguna">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <p>Anda sudah punya akun? <a href="layouts_m5/login">Login</a></a></p>
                    </form>
    </div></div>
  </body>
</html>