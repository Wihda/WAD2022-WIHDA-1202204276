...
//     session_start();
// }
// require '../MODUL4 WIHDA/config/connector.php';
?>
  ...
  <body>
    <div class="row">
      ...
      <div class="col-6" style="padding-top:100px; padding-left:100px">
        <h3>Login</h3><br>
        <form action="{{url('/layouts_m5/home-after')}}" method="GET" enctype="multipart/form-data">
        @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <p>Anda belum punya akun? <a href="{{url('/register')}}">Daftar</a></a></p>
        </form>
    </div></div>
  </body>
