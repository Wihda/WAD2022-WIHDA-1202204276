  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark p-3">
        <div class="container-fluid">
            ...
            <li><a href="/layouts_m5" class="btn btn-light btn-outline-primary" style="margin-right:50px">Add Car</a></li>
            <div class="dropdown">
      ...
      //   $id_mobil = $record['id']
        ?>
          ...
          <div class="col-sm">
            ...
            <img class="card-img-top p-3" src="{{ route('store')}}" alt=""> 
            <div class="card-body">
              <h4 class="card-title">{{ route('store')}}</h4>
              <p class="card-text">{{ route('store')}}</p>
            </div>
            <div class="card-footer">
              <div class="row justify-content-start">
                <div class="col-4">
              <form action="/layouts_m5" method="POST" >
                <input type="hidden" name="id_mobil" value="{{ route('store')}}" />
                <input style="width: 100%" type="submit" class="btn btn-primary rounded-pill" value="Detail">
              </form></div>
              <div class="col-4">
              <form action="/layouts_m5" method="delete" >
                <input type="hidden" name="id_mobil" value="{{ route('store')}}" />
